...
<build> <!-- For Kotlin 2.0 or higher -->
    <plugins>
        ...
        <plugin>
            ...
            <configuration>
                <jvmTarget>17</jvmTarget>
                <apiVersion>2.4.20</apiVersion>
                <languageVersion>2.4.20</languageVersion>
...
dependencies {
    ...
    ksp("care.better.pf4j:pf4j-kotlin-symbol-processing:2.4.20-1.0.5")
}
```